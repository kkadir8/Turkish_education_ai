...
export default function AudioEducationPage() {
    ...
    return (
        <div className="min-h-screen h-screen overflow-hidden flex flex-col">
            {/* Fixed Background - Never scrolls, always covers viewport */}
            <div
            ...
            {/* Animated Abstract Circles - Fixed position */}
            ...
            {/* Main Content - Centered with proper navbar spacing */}
            <div className="flex-1 flex flex-col items-center justify-center px-4 pt-16 pb-4">
                ...
                >
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500/20 to-violet-500/20 border border-cyan-400/30 px-4 py-2 rounded-full mb-3 backdrop-blur-sm">
                        ...
                        <span className="text-cyan-300 text-sm font-medium">AI Destekli Konuşma Pratiği</span>
                    </div>
                ...
                >
                    {/* Glow Effect Under Robot - Animated when speaking */}
                    <motion.div
                        animate={isTalking ? {
                            opacity: [0.4, 0.8, 0.4],
                            scale: [1, 1.1, 1]
                    ...
                    {/* 3D Scene - Robot floating with bounce animation when speaking */}
                    <motion.div
                        animate={isTalking ? {
                            y: [0, -8, 0, -4, 0],
                ...
                >
                    ...
                    <div className="flex items-center gap-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
                        <span className="text-slate-300 text-xs">🎙️ Mikrofon gerekli</span>
                    </div>
                </motion.div>
            </div>
        </div>
